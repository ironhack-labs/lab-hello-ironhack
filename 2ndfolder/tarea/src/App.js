...
function App() {
  return (
    ...
    <div className="content">
       ...
       <h4>You will learn a Frontend <br/>framework from scratch to <br/>become an Ninja Developer</h4>
    ...
    <div className="images">
      <ul>
        ...
        <li>
         ...
         <div className="textImages">      
         <h2>Single-Way</h2>
         <p>Aset of inmutable <br/>values are passed to <br/>the component´s</p>
         </div>
        </li>
        <li>
