  ...
  return (
    <>
      ...
      <div className= "cards-container">
        <Card imgSource={content.imgOne} subtitle='Declarative' text={content.text1}/>
        <Card imgSource={content.imgTwo} subtitle='Components' text={content.text2}/>
        <Card imgSource={content.imgThree} subtitle='Single-Way' text={content.text3}/>
